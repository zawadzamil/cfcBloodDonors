    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-6 text-center mb-5">
                <h2 class="heading-section">ADMIN PANEL SIGN UP</h2>
            </div>
        </div>
        <div class="row justify-content-center">
            <div class="col-md-6 col-lg-4">
                <div class="login-wrap p-0">
                    ...
                    <form action="{{url('stroreAdmin')}}" class="signin-form" method="POST">
                        @csrf
                        ...
                        <div class="form-group d-md-flex">
                            ...
                            <div class="w-50 text-md-right">
                                <a href="{{url("admin")}}" style="color: #fff">Already Registered?</a>
                            </div>
                        </div>
                    </form>
